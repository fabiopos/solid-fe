            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                ...
                <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                    <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                        <p className="text-xl/8 text-gray-800 dark:text-gray-300">
                        ...
                        <dl className="w-64 space-y-8 xl:w-80">
                            {stats.map((stat) => (
                                <div key={stat.label} className="flex flex-col-reverse gap-y-4">
                                    <dt className="text-base/7  text-cyan-500 dark:text-gray-100">{stat.label}</dt>
                                    <dd className="text-lg font-semibold tracking-tight text-cyan-600 dark:text-cyan-300">{stat.value}</dd>
                                </div>
                            ))}
                        </dl>
                    </div>
